...
Panel {
  ...
  readonly property bool isConnected: (kind === "wifi" && !!connectedWifiNetwork) || (kind === "ethernet" && hasEthernet)
  readonly property bool isNetworkAlert: isWifiEnabled && !isConnected
